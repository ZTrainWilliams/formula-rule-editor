  ...
  (function () {
    ...
    Build.prototype.run = function () {
      ...
      window.addEventListener(
        'mousemove',
        function (e) {
          this.toX = (e.clientX - this.canvas.width / 2) * -0.3;
          this.toY = (e.clientY - this.canvas.height / 2) * 0.3;
        }.bind(this)
      );
      window.addEventListener(
        'touchmove',
        function (e) {
          e.preventDefault();
          this.toX = (e.touches[0].clientX - this.canvas.width / 2) * -0.3;
          this.toY = (e.touches[0].clientY - this.canvas.height / 2) * 0.3;
        }.bind(this)
      );
      window.addEventListener(
        'mousedown',
